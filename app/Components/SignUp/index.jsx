        ...
        <div className="grid gap-4 py-4">
          ...
          <Tabs defaultValue="account" className="w-[300px] mx-auto">
            ...
            <TabsContent value="account">
                <form action="" onSubmit={SignUp}></form>
              <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="name" className="text-right">
              Name
            </Label>
            <input id="name" value= {user.name} className="col-span-3" onChange={(e) => setUser(e.target.value)} />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="username" className="text-right">
              Surename
            </Label>
            <input id="name" value= {user.Surename} className="col-span-3" onChange={(e) => setUser(e.target.value)} />
          </div>
         <form action="">
         <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="username" className="text-right">
